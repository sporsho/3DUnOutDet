...
def main(args):
    ...
    optimizer = QHAdam(model.parameters(), lr=1e-2, nus=(0.7, 1.0), betas=(0.99, 0.999))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--model_save_path',
                        default='/var/local/home/aburai/DATA/exp_2024/bin_seg/UnOutDet')
